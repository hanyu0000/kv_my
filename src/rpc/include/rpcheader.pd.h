...
inline void RpcHeader::set_service_name(std::string&& value) {
  service_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
...
inline void RpcHeader::unsafe_arena_set_allocated_service_name(std::string* service_name) {
  ...
  service_name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), service_name,
                                        GetArena());
...
inline void RpcHeader::set_method_name(const char* value) {
  ...
  method_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value), GetArena());
...
inline void RpcHeader::set_allocated_method_name(std::string* method_name) {
  ...
  method_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), method_name, GetArena());
...
inline std::string* RpcHeader::unsafe_arena_release_method_name() {
  ...
  return method_name_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
